...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor):
        ...
        # [Batch_Size, Embed_Dim, Num_Patches_H, Num_Patches_W] where Num_Patches_H = height // patch_size and Num_Patches_W = width // patch_size
        patch_embeds = self.patch_embedding(pixel_values)  
        # [Batch_Size, Embed_Dim, Num_Patches_H, Num_Patches_W] -> [Batch_Size, Embed_Dim, Num_Patches] where Num_Patches = Num_Patches_H * Num_Patches_W
...
class SiglipAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor):
        ...
        batch_size, num_patches, _ = hidden_states.size()
        ...
        # Calculate attention using the formula Q * K^T / sqrt(d_k). attn_weights: [Batch_Size, Num_Heads, Num_Patches, Num_Patches]
